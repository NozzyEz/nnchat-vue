...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            generatePublic() {
                return this.dh("3", this.$store.state.credentials.secret, this.$store.state.publicMod)
            },
            // Generates a shared encryption key out of their public key fragment
            generateShared(publicKey) {
                return this.dh(publicKey, this.$store.state.credentials.secret, this.$store.state.publicMod)
            },
